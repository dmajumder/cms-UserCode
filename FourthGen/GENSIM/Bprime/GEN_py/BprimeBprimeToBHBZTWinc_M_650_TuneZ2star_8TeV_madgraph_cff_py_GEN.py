...
# with command line options: Configuration/GenProduction/python/EightTeV/BprimeBprimeToBHBZTWinc_M_650_TuneZ2star_8TeV_madgraph_cff.py --filein lhe:6153 -s GEN --conditions START52_V9::All --beamspot Realistic8TeVCollision --datatier GEN-SIM --eventcontent RAWSIM -n 1000 --no_exec
...
process.source = cms.Source("LHESource",
    fileNames = cms.untracked.vstring('/store/lhe/6153/8TeV_bpbpbar_650_6.50_run10853_unweighted_events_qcut65_mgPostv2.lhe', 
        '/store/lhe/6153/8TeV_bpbpbar_650_6.50_run12529_unweighted_events_qcut65_mgPostv2.lhe', 
        '/store/lhe/6153/8TeV_bpbpbar_650_6.50_run20229_unweighted_events_qcut65_mgPostv2.lhe', 
        '/store/lhe/6153/8TeV_bpbpbar_650_6.50_run21409_unweighted_events_qcut65_mgPostv2.lhe', 
        '/store/lhe/6153/8TeV_bpbpbar_650_6.50_run6701_unweighted_events_qcut65_mgPostv2.lhe')
)
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Configuration/GenProduction/python/EightTeV/BprimeBprimeToBHBZTWinc_M_650_TuneZ2star_8TeV_madgraph_cff.py nevts:1000'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('BprimeBprimeToBHBZTWinc_M_650_TuneZ2star_8TeV_madgraph_cff_py_GEN.root'),
...
process.generator = cms.EDFilter("Pythia6HadronizerFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring('PMAS(25,1)= 125.00D0    !mass of Higgs', 
            ...
            'BRAT(56)  = 0.0D0', 
            'BRAT(57)  = 0.0D0', 
            'BRAT(58)  = 0.33333333D0', 
            'BRAT(59)  = 0.0D0', 
            'BRAT(60)  = 0.0D0', 
            'BRAT(61)  = 0.33333333D0', 
            'BRAT(62)  = 0.0D0', 
            'BRAT(63)  = 0.33333333D0', 
            'BRAT(64)  = 0.0D0', 
            'BRAT(65)  = 0.0D0', 

...
# with command line options: Configuration/GenProduction/python/EightTeV/TprimeTprimeToTHTZBWinc_M_550_TuneZ2star_8TeV_madgraph_cff.py --filein lhe:6164 -s GEN --conditions START52_V9::All --beamspot Realistic8TeVCollision --datatier GEN-SIM --eventcontent RAWSIM -n 1000 --no_exec
...
process.source = cms.Source("LHESource",
    fileNames = cms.untracked.vstring('/store/lhe/6164/8TeV_tptpbar_550_5.50_run21318_unweighted_events_qcut60_mgPostv2.lhe', 
        '/store/lhe/6164/8TeV_tptpbar_550_5.50_run355_unweighted_events_qcut60_mgPostv2.lhe', 
        '/store/lhe/6164/8TeV_tptpbar_550_5.50_run5450_unweighted_events_qcut60_mgPostv2.lhe', 
        '/store/lhe/6164/8TeV_tptpbar_550_5.50_run5454_unweighted_events_qcut60_mgPostv2.lhe', 
        '/store/lhe/6164/8TeV_tptpbar_550_5.50_run5779_unweighted_events_qcut60_mgPostv2.lhe')
)
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Configuration/GenProduction/python/EightTeV/TprimeTprimeToTHTZBWinc_M_550_TuneZ2star_8TeV_madgraph_cff.py nevts:1000'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('TprimeTprimeToTHTZBWinc_M_550_TuneZ2star_8TeV_madgraph_cff_py_GEN.root'),
...
process.generator = cms.EDFilter("Pythia6HadronizerFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring('PMAS(25,1)= 125.00D0    !mass of Higgs', 
            ...
            'PMAS(8,2) = 5.500D0    ! tprime quark width', 
            'PMAS(8,3) = 55.00D0 ! Max value above which the BW shape is truncated', 

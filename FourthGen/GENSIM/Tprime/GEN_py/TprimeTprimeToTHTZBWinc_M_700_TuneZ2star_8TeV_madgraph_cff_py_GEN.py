...
# with command line options: Configuration/GenProduction/python/EightTeV/TprimeTprimeToTHTZBWinc_M_700_TuneZ2star_8TeV_madgraph_cff.py --filein lhe:6170 -s GEN --conditions START52_V9::All --beamspot Realistic8TeVCollision --datatier GEN-SIM --eventcontent RAWSIM -n 1000 --no_exec
...
process.source = cms.Source("LHESource",
    fileNames = cms.untracked.vstring('/store/lhe/6170/8TeV_tptpbar_700_7._run11091_unweighted_events_qcut70_mgPostv2.lhe', 
        '/store/lhe/6170/8TeV_tptpbar_700_7._run1129_unweighted_events_qcut70_mgPostv2.lhe', 
        '/store/lhe/6170/8TeV_tptpbar_700_7._run19851_unweighted_events_qcut70_mgPostv2.lhe', 
        '/store/lhe/6170/8TeV_tptpbar_700_7._run23342_unweighted_events_qcut70_mgPostv2.lhe', 
        '/store/lhe/6170/8TeV_tptpbar_700_7._run6739_unweighted_events_qcut70_mgPostv2.lhe')
)
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Configuration/GenProduction/python/EightTeV/TprimeTprimeToTHTZBWinc_M_700_TuneZ2star_8TeV_madgraph_cff.py nevts:1000'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('TprimeTprimeToTHTZBWinc_M_700_TuneZ2star_8TeV_madgraph_cff_py_GEN.root'),
...
process.generator = cms.EDFilter("Pythia6HadronizerFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring('PMAS(25,1)= 125.00D0    !mass of Higgs', 
            ...
            'PMAS(8,2) = 7.000D0    ! tprime quark width', 
            'PMAS(8,3) = 70.00D0 ! Max value above which the BW shape is truncated', 

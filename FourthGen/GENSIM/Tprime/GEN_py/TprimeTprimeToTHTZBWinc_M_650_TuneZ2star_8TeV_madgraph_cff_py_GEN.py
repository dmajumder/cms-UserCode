...
# with command line options: Configuration/GenProduction/python/EightTeV/TprimeTprimeToTHTZBWinc_M_650_TuneZ2star_8TeV_madgraph_cff.py --filein lhe:6168 -s GEN --conditions START52_V9::All --beamspot Realistic8TeVCollision --datatier GEN-SIM --eventcontent RAWSIM -n 1000 --no_exec
...
process.source = cms.Source("LHESource",
    fileNames = cms.untracked.vstring('/store/lhe/6168/8TeV_tptpbar_650_6.50_run14381_unweighted_events_qcut70_mgPostv2.lhe', 
        '/store/lhe/6168/8TeV_tptpbar_650_6.50_run19866_unweighted_events_qcut70_mgPostv2.lhe', 
        '/store/lhe/6168/8TeV_tptpbar_650_6.50_run20183_unweighted_events_qcut70_mgPostv2.lhe', 
        '/store/lhe/6168/8TeV_tptpbar_650_6.50_run6728_unweighted_events_qcut70_mgPostv2.lhe', 
        '/store/lhe/6168/8TeV_tptpbar_650_6.50_run9898_unweighted_events_qcut70_mgPostv2.lhe')
)
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Configuration/GenProduction/python/EightTeV/TprimeTprimeToTHTZBWinc_M_650_TuneZ2star_8TeV_madgraph_cff.py nevts:1000'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('TprimeTprimeToTHTZBWinc_M_650_TuneZ2star_8TeV_madgraph_cff_py_GEN.root'),
...
process.generator = cms.EDFilter("Pythia6HadronizerFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring('PMAS(25,1)= 125.00D0    !mass of Higgs', 
            ...
            'PMAS(8,2) = 6.500D0    ! tprime quark width', 
            'PMAS(8,3) = 65.00D0 ! Max value above which the BW shape is truncated', 
            ...
            'MDME(72,1)=0     ! W b4', 
            'KFDP(73,2)=6     ! defines H0 t (no check)', 
            'MDME(73,1)=1     ! h0 t4', 
            'MDME(74,1)=-1    ! H+ b', 
            'MDME(75,1)=-1    ! H+ b4', 
            'BRAT(66)  = 0.0D0', 
            'BRAT(67)  = 0.0D0', 
            'BRAT(68)  = 0.33333333D0', 
            'BRAT(69)  = 0.0D0', 
            'BRAT(70)  = 0.0D0', 
            'BRAT(71)  = 0.33333333D0', 
            'BRAT(72)  = 0.0D0', 
            'BRAT(73)  = 0.33333333D0', 
            'BRAT(74)  = 0.0D0', 
            'BRAT(75)  = 0.0D0', 
            ...
            'MDME(209,1)=-1    !W decay into tau4 nu_tau4MDME(174,1)=1     !Z decay into d dbar', 

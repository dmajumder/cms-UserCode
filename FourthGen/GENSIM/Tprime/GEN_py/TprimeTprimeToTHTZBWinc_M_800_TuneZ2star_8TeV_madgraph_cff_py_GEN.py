...
# with command line options: Configuration/GenProduction/python/EightTeV/TprimeTprimeToTHTZBWinc_M_800_TuneZ2star_8TeV_madgraph_cff.py --filein lhe:6174 -s GEN --conditions START52_V9::All --beamspot Realistic8TeVCollision --datatier GEN-SIM --eventcontent RAWSIM -n 1000 --no_exec
...
process.source = cms.Source("LHESource",
    fileNames = cms.untracked.vstring('/store/lhe/6174/8TeV_tptpbar_800_8._run12291_unweighted_events_qcut70_mgPostv2.lhe', 
        '/store/lhe/6174/8TeV_tptpbar_800_8._run20819_unweighted_events_qcut70_mgPostv2.lhe', 
        '/store/lhe/6174/8TeV_tptpbar_800_8._run25326_unweighted_events_qcut70_mgPostv2.lhe', 
        '/store/lhe/6174/8TeV_tptpbar_800_8._run32656_unweighted_events_qcut70_mgPostv2.lhe', 
        '/store/lhe/6174/8TeV_tptpbar_800_8._run9088_unweighted_events_qcut70_mgPostv2.lhe')
)
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Configuration/GenProduction/python/EightTeV/TprimeTprimeToTHTZBWinc_M_800_TuneZ2star_8TeV_madgraph_cff.py nevts:1000'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('TprimeTprimeToTHTZBWinc_M_800_TuneZ2star_8TeV_madgraph_cff_py_GEN.root'),
...
process.generator = cms.EDFilter("Pythia6HadronizerFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring('PMAS(25,1)= 125.00D0    !mass of Higgs', 
            ...
            'PMAS(8,2) = 8.000D0    ! tprime quark width', 
            'PMAS(8,3) = 80.00D0 ! Max value above which the BW shape is truncated', 

...
# with command line options: Configuration/GenProduction/python/EightTeV/Bprime/BprimeBprimeToBHBH_HToBB_M_450_TuneZ2star_8TeV_madgraph_cff.py --filein lhe:6145 --step GEN,FASTSIM,HLT:7E33v2 --conditions START53_V7A::All --pileup 2012_Summer_inTimeOnly --datamix NODATAMIXER --beamspot Realistic8TeVCollision --eventcontent AODSIM --datatier AODSIM --no_exec -n -1
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Configuration/GenProduction/python/EightTeV/Bprime/BprimeBprimeToBHBH_HToBB_M_450_TuneZ2star_8TeV_madgraph_cff.py nevts:-1'),
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('BprimeBprimeToBHBH_HToBB_M_450_TuneZ2star_8TeV_madgraph_cff_py_GEN_FASTSIM_HLT_PU.root'),

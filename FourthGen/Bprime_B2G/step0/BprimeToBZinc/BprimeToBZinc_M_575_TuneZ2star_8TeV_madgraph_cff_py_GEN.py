...
# with command line options: Configuration/GenProduction/python/EightTeV/Bprime_B2G/BprimeToBZinc_M_575_TuneZ2star_8TeV_madgraph_cff.py --filein lhe:6465 -s GEN --conditions START52_V9::All --beamspot Realistic8TeVCollision --datatier GEN-SIM --eventcontent RAWSIM -n 1000 --no_exec
...
process.source = cms.Source("LHESource",
    fileNames = cms.untracked.vstring('/store/lhe/6465/8TeV_bp_575_5.75_run30828_unweighted_events_qcut0_mgPostv2.lhe')
)
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Configuration/GenProduction/python/EightTeV/Bprime_B2G/BprimeToBZinc_M_575_TuneZ2star_8TeV_madgraph_cff.py nevts:1000'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('BprimeToBZinc_M_575_TuneZ2star_8TeV_madgraph_cff_py_GEN.root'),

...
# with command line options: Configuration/GenProduction/python/EightTeV/Bprime_B2G/BprimeToBHinc_M_1000_TuneZ2star_8TeV_madgraph_cff.py --filein lhe:6482 -s GEN --conditions START52_V9::All --beamspot Realistic8TeVCollision --datatier GEN-SIM --eventcontent RAWSIM -n 1000 --no_exec
...
process.source = cms.Source("LHESource",
    fileNames = cms.untracked.vstring('/store/lhe/6482/8TeV_bp_1000_10_run8231_unweighted_events_qcut0_mgPostv2.lhe')
)
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Configuration/GenProduction/python/EightTeV/Bprime_B2G/BprimeToBHinc_M_1000_TuneZ2star_8TeV_madgraph_cff.py nevts:1000'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('BprimeToBHinc_M_1000_TuneZ2star_8TeV_madgraph_cff_py_GEN.root'),
...
process.generator = cms.EDFilter("Pythia6HadronizerFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring('PMAS(25,1)=125.00D0    !mass of Higgs', 
            ...
            'PMAS(7,1) = 1000.D0     ! bprime quark mass', 
            'PMAS(7,2) = 10.00D0                       ', 
            'PMAS(7,3) = 100.0D0                ', 

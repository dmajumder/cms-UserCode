...
# with command line options: Configuration/GenProduction/python/EightTeV/Bprime_B2G/BprimeToBHinc_M_750_TuneZ2star_8TeV_madgraph_cff.py -s GEN,SIM --filetype=LHE --filein=6472 --beamspot Realistic8TeVCollision --conditions START52_V9::All --pileup NoPileUp --datatier GEN-SIM --eventcontent RAWSIM -n 30 --no_exe
...
process.source = cms.Source("LHESource",
    fileNames = cms.untracked.vstring('6472')
)
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Configuration/GenProduction/python/EightTeV/Bprime_B2G/BprimeToBHinc_M_750_TuneZ2star_8TeV_madgraph_cff.py nevts:30'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('BprimeToBHinc_M_750_TuneZ2star_8TeV_madgraph_cff_py_GEN_SIM.root'),
